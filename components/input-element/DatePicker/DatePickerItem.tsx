...
import { IDatePicker, hasValueDisableInput } from "@/lib";
...
export const ConvertUnixToDateOrNull = (unixTime) => {
	let result = null;
	if(isValid(unixTime)) {
...
// export const ConvertStringDateToDate = (dateString) => {
// 	let result = moment(dateString, 'yyyy-MM-dd', new Date());
// 	return result;
// };
                            ...
                            <DayPicker
                                ...
                                onSelect={(dDate) => {
                                    ...
                                    if(dDate)
                                    {
                                        ...
                                        unixTimestamp = ConvertDateToUnixOrNull(dDate);
                                        // console.log("unixTimestamp",ConvertUnixToDateOrNull(unixTimestamp));
                                    }
